...
public class fieldNavigationTest extends LinearOpMode {
    ...
    @Override public void runOpMode() {
        ...
        final float CAMERA_VERTICAL_DISPLACEMENT = 8.0f * mmPerInch;   // eg: Camera is 6 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = -5.5f * mmPerInch;   // eg: Enter the left distance from the center of the robot to the camera lens
